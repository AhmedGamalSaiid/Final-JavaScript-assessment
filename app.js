/**
 * JavaScript Programming Assessment Application
 * A comprehensive assessment platform for JavaScript programming skills
 *
 * Features:
 * - 72 questions across 8 programming units
 * - 25-minute timer with visual feedback
...
const CONFIG = {
  ...
  units: 8,
  googleSheetsUrl:
    "https://script.google.com/macros/s/AKfycbzbqjJeMgMgsObNyjUraE56VhANJ07K2b6k_oXoBDfSqB1t4hVMg3A9dCunc0STso8rKQ/exec",
  storageKeys: {
 ...
 */
const QUESTION_BANK = [
  // Unit 1: Programming Foundations & JavaScript Setup (9 questions)
  {
    id: "u1_01",
    unit: 1,
    level: "easy",
    type: "mcq",
    question: "What is programming primarily about?",
    options: [
  ...
  },
  {
    ...
    level: "easy",
    type: "mcq",
    question: "Which IDE is commonly used for JavaScript development?",
    options: [
      "Microsoft Word",
      "Adobe Photoshop",
      "Visual Studio Code",
  ...
  },
  {
    ...
    options: [
      ...
      "Compiled languages can't run on multiple platforms",
  ...
  },
  {
    ...
    level: "medium",
    type: "mcq",
    question: "Which environment allows JavaScript to run on the server?",
    options: ["Chrome Browser", "Node.js", "Firefox", "Internet Explorer"],
    correctAnswer: 1,
  },
  {
    id: "u1_06",
  ...
  },
  {
    ...
    level: "medium",
    type: "mcq",
    question: "JavaScript can run in which environments?",
    options: [
  ...
  },
  {
    ...
    type: "code",
    question:
      "What happens when you include JavaScript in HTML using both internal and external methods for the same functionality?",
    options: [
      "Only internal JavaScript runs",
      "Only external JavaScript runs",
      "Both run in the order they appear",
      "It causes an error",
    ],
    correctAnswer: 2,
  },

  // Unit 2: Variables, Data Types & Memory Management (9 questions)
  {
    id: "u2_01",
    unit: 2,
    level: "hard",
  ...
  },
  {
    ...
    options: [
      ...
      "The behavior where declarations are moved to the top of their scope",
  ...
  // Unit 3: Operators & Expressions (9 questions)
  {
    id: "u3_01",
    unit: 3,
    level: "hard",
  ...
  },
  {
    ...
    level: "medium",
    type: "mcq",
    question: "Which operator checks both type and value for equality?",
    options: ["=", "==", "===", "!="],
    correctAnswer: 2,
  },
  {
  ...
  },
  {
    ...
    options: ["parseInt()", "toString()", "valueOf()", "stringify()"],
    correctAnswer: 0,
  },
  {
    id: "u3_06",
  ...
  },
  {
    ...
    level: "easy",
    type: "mcq",
    question: "Are arrays a primitive data type in JavaScript?",
    options: [
      "Yes, they are primitive",
      "No, they are objects",
      "Only if they contain primitives",
      "It depends on their length",
    ],
    correctAnswer: 1,
  },

  // Unit 4: Control Flow & User Interaction (9 questions)
  {
    id: "u4_01",
    unit: 4,
    level: "hard",
  ...
  },
  {
    ...
    type: "mcq",
    question:
      "What is the main advantage of switch over multiple if-else statements?",
    options: [
      "Switch is always faster",
      "Switch uses strict equality comparison",
      "Switch is more readable for multiple conditions",
      "Switch can handle ranges",
    ],
    correctAnswer: 2,
  },
  {
    ...
    question:
      'What is logged?\n\nlet x = 5;\nswitch (x) {\n  case 5:\n    console.log("five");\n  case 6:\n    console.log("six");\n    break;\n  default:\n    console.log("other");\n}',
    options: ["five", "six", "five six", "five six other"],
    correctAnswer: 2,
  },
  {
    id: "u4_07",
    ...
    type: "mcq",
    question:
      "Which keyword skips the current iteration and continues with the next?",
  ...
  },
  {
    ...
    level: "easy",
    type: "mcq",
    question: "Can the ternary operator replace simple if-else statements?",
    options: [
      "No, never",
  ...
  // Unit 5: Functions & Reusable Code (9 questions)
  {
    id: "u5_01",
    unit: 5,
    level: "easy",
    type: "mcq",
    question: "How do you define a function declaration in JavaScript?",
    options: [
      "function myFunc() {}",
      "def myFunc():",
      "func myFunc() {}",
  ...
  },
  {
    ...
    question:
      'What is returned?\n\nfunction test() {\n  return 5;\n  console.log("hello");\n}\nlet result = test();\nconsole.log(result);',
    options: ["hello", "5", "undefined", "hello 5"],
    correctAnswer: 1,
  },
  {
    id: "u5_03",
    ...
    options: [
      "Yes, they create their own this",
      "No, they inherit this from enclosing scope",
      "Only in strict mode",
      "Only when used as methods",
    ],
    correctAnswer: 1,
  },
  {
  ...
  },
  {
    ...
    options: [
      "Functions are moved to global scope",
  ...
  // Unit 6: Built-in Objects & Data Structures (9 questions)
  {
    id: "u6_01",
    unit: 6,
    level: "easy",
    type: "mcq",
    question: "Which of these creates an empty array?",
  ...
  },
  {
    ...
    level: "easy",
    type: "mcq",
    question: "Are objects in JavaScript mutable?",
    options: [
  ...
  },
  {
    ...
    type: "mcq",
    question:
      "What happens when you use the delete operator on an array element?",
    options: [
      "The element is removed and array length decreases",
      "The element becomes undefined but length stays same",
      "It throws an error",
  ...
  // Unit 7: Advanced Functions & Patterns (9 questions)
  {
    id: "u7_01",
    unit: 7,
    level: "hard",
  ...
  },
  {
    ...
    options: [
      ...
      "Instantly Invoked Function Element",
      "Immediate Interface Function Extension",
    ],
    correctAnswer: 0,
  },
  {
    ...
    question:
      'What is logged?\n\nfunction test() {\n  console.log(this);\n}\ntest.call({name: "John"});',
    options: ["undefined", "window object", '{name: "John"}', "Error"],
    correctAnswer: 2,
  },
  {
    id: "u7_04",
  ...
  },
  {
    ...
    type: "code",
    question:
      "What does this factorial function return for factorial(3)?\n\nfunction factorial(n) {\n  return n <= 1 ? 1 : n * factorial(n - 1);\n}",
    options: ["3", "6", "9", "Stack overflow"],
    correctAnswer: 1,
  },
  {
    id: "u7_08",
    ...
    options: [
      ...
      "Binds variables to global scope",
  ...
  },
  {
    ...
    options: ["Hello, Alice", "Hello, undefined", "Hello,", "Error"],
    correctAnswer: 1,
  },

  // Unit 8: DOM Manipulation & Browser Object Model (9 questions)
  {
    id: "u8_01",
    unit: 8,
    level: "easy",
  ...
  },
  {
    ...
    level: "medium",
    type: "mcq",
    question: "Can querySelector() use CSS selectors?",
    options: [
      "No, only IDs",
      "No, only classes",
      "Yes, any CSS selector",
  ...
  },
  {
    ...
    options: ["addEventListener()", "addEvent()", "on()", "listen()"],
    correctAnswer: 0,
  },
  {
    id: "u8_05",
  ...
  },
  {
    ...
    level: "medium",
    type: "mcq",
    question: "Which property safely sets only the text content of an element?",
  ...
  },
  {
    ...
    level: "hard",
    type: "mcq",
    question: "What is a potential security risk with innerHTML?",
    options: [
      "It's too slow",
      "It can execute malicious scripts",
  ...
  async saveToGoogleSheets(results) {
    ...
    try {
      ...
      try {
        ...
        console.log('FormData POST failed, trying alternative method...', fetchError);
      }
...
class ThemeManager {
  ...
  applyTheme(theme) {
    ...
    if (this.themeToggle) {
      ...
      this.themeToggle.setAttribute('title', `Switch to ${theme === 'light' ? 'dark' : 'light'} mode`);
    }
  }
